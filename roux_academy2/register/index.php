...
<div class="wrapper">
  ...
  <section id="main">
    ...
    <article id="registrationform">
      <form id="datos" method="POST" enctype="text/plain">
        <fieldset>
          ...
          <ol>
            ...
            <li>
              ...
              <input type="email" name="myemail" id="myemail" required autofocus autocomplete="off">
            </li>
            <li>
              <div class="grouphead">Request Type</div>
              <ol>
                <li>
                  <input type="radio" name="requesttype" value="question" autofocus id="question">
                  <label for="question">Question</label>
                </li>
                <li>
                  <input type="radio" name="requesttype" value="comment" autofocus id="comment">
            ...
            <li>
              ...
              <textarea name="mycomments" autofocus id="mycomments"></textarea>
            </li>
            <li class="singleline">
              <input type="checkbox" id="subscribe" name="subscribe" autofocus checked="" value="yes">
              <label for="subscribe">Subscribe to our mailing list?</label>
            </li>
            <li>
              <label for="reference">How did you hear about us?</label>
              <select name="reference" autofocus id="reference">
...
<script>
  $( "#datos" ).submit(()=>{
      ...
      var type = $('input[name=requesttype]:checked').val();
      var comments = $('#mycomments').val();
      var subs =  $('#mycomments').val();
      var ref =  $('#reference').val();
      var posting = $.post('/roux_academy/register/add.php', { 
        'name': name, 
        'company': company, 
        'mail':mail,
        'type':type,
        ...
        posting.done(function( data ) {
          var datos = data;
          $( "#result" ).empty().append( datos.content );
        });
    }
  );
</script>